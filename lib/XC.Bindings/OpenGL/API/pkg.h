...
void glUniformMatrix2x3f(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
...
void glMultiDrawArraysIndirectCount(GLenum mode, const void *indirect, GLsizei drawcount, GLsizei stride);
